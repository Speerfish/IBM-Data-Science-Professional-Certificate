...
def update_piegraph(site_dropdown):
    if (site_dropdown == 'All Sites' or site_dropdown == 'None'):
        ...
        fig = px.pie(
                data,
                names = 'class',
                title = 'Total Successful Launches at Site &#8608; '+site_dropdown,
            )
    return fig
...
def update_scattergraph(site_dropdown,payload_slider):
    if (site_dropdown == 'All Sites' or site_dropdown == 'None'):
        ...
        fig = px.scatter(
                ...
                x = "Payload Mass (kg)", 
                y = "class",
                title = 'Correlation Between Payload & Launch Success for All Launch Sites',
                color='Booster Rocket Version Category',
                size='Booster RocketPayload Mass (kg)',
                hover_data=['Booster Rocket Payload Mass (kg)']
            )
    else:
        low, high = payload_slider
        data  = spacex_df.loc[spacex_df['Launch Site'] == site_dropdown]
        ...
        fig = px.scatter(
                data[inrange],
                x = "Booster Rocket Payload Mass (kg)",
                y = "class",
                title = 'Correlation Between Payload and Launch Success for Site &#8608; '+site_dropdown,
                color='Booster Rocket Version Category',
